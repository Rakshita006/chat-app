...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-center bg-cover flex items-center justify-center gap-8 sm:justify-evenly 
      ...
      <h2 className='font-medium text-2xl flex justify-between items-center'>
...

        {
          !isDataSubmitted && (
            ...
            type="email" placeholder='email' className='p-2 border border-gray-500 rounded-md focus:outline-none
            focus: ring-indigo-500' required/>
            
            <input onChange={(e)=>setPassword(e.target.value)} value={password}
            type="password" placeholder='password'  className='p-2 border border-gray-500 rounded-md focus:outline-none
            focus: ring-indigo-500' required/>
            </>
          )
        }
